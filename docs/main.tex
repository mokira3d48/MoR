...
Testé sur des modèles de 135M à 1,7B de paramètres sous des budgets de calcul
identiques, MoR établit une nouvelle frontière de Pareto en améliorant
simultanément la loss de validation et les performances en few-shot learning.
Enfin, son design réduit drastiquement les coûts d’entraînement (FLOPs),
allège la mémoire à l’inférence et augmente le débit de génération grâce
à un batching optimisé.
